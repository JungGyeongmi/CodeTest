...
public class Tree2 {
    ...
    private static String preorder(Node node) {
        ...
        retVal += node.self;
        if (node.left != null)
            retVal += preorder(node.left);
        if (node.right != null)
            retVal += preorder(node.right);
        return retVal;
    }
    ...
    private static String inorder(Node node) {
        String retVal = "";
        if (node.left != null)
            retVal += inorder(node.left);
        retVal += node.self;
        if (node.right != null)
            retVal += inorder(node.right);
        return retVal;
    }
    ...
    private static String postorder(Node node) {
        String retVal = "";
        if (node.left != null)
            retVal += postorder(node.left);
        if (node.right != null)
            retVal += postorder(node.right);
        retVal += node.self;
        return retVal;
    }
